...
$_config = array(
    ...
    'WEBSITE_DOMAIN'       => 'http://www.ffgame.com', // 官方网址
    'UPDATE_URL'           => '/appstore/home/core/update', // 官方更新网址
    'TEAM_TITLE'           => '山西魔娅网络科技有限公司', // 公司名称
    'TEAM_MEMBER'          => '江如意、赵瀚卿、张玥、潘美红', // 团队成员
    'TEAM_ADDRESS'         => '太原市小店区广东路38号', // 公司地址
    'TEAM_EMAIL'           => '7661660@qq.com', // 公司邮箱
    'TEAM_PHONE'           => '18935034903', // 公司电话
    'TEAM_QQ'              => '112368602 ', // 公司QQ
    'TEAM_QQQUN'           => ' ', // 公司QQ群
    ...
    'URL_ROUTE_RULES'      => array(
        ...
        'api/:id\d'=>'Home/nav/post'
    ),

    // 应用配置
    'DEFAULT_MODULE'       => 'Home',
    'MODULE_DENY_LIST'     => array('Common'),
    'MODULE_ALLOW_LIST'    => array('Home', 'Install','Api','User'),
...
if (is_file('./Data/db.php')) {
    ...
    if (@$_SERVER[ENV_PRE . 'DEV_MODE'] === 'true') {
        ...
        $db_config = array(
            ...
            'DB_NAME'   => @$_SERVER[ENV_PRE . 'DB_NAME'] ?: 'moya', // 数据库名
