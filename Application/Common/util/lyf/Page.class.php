...
private $select=<<<str
    <select name="}" class="form-control lyui-select perpageselect " >
        ...
        <option value="5000" >显示5000条页</option>
     </select>
str;
    // 分页显示定制
    ...
    public function show()
    {
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        $totalrow=str_replace("%TOTAL_ROW%",$this->totalRows,$this->config['header']);
        $page_str ="<ul class=\"pagination\">". $page_str."</ul>";
        $page_str = $totalrow.$page_str.$this->select;
