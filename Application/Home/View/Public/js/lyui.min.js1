+ function (t) {
    ...
    function (t) {
        ...
        s.VERSION = "3.3.5", s.TRANSITION_DURATION = 150, s.prototype.close = function (e) {
            ...
            var n = t(o);
            e && e.preventDefault(), n.length || (n = a.closest(".alert")), n.trigger(e = t.Event("close.bs.alert")), e.isDefaultPrevented() || (n.removeClass("in"), t.support.transition && n.hasClass("fade") ? n.one("bsTransitionEnd", i).emulateTransitionEnd(s.TRANSITION_DURATION) : i())
        };
        var a = t.fn.alert;
    ...
    function (t) {
        ...
        i.VERSION = "3.3.5", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
            ...
            if ("bottom" == this.affixed) return null != i ? !(a + this.unpin <= o.top) && "bottom" : !(a + n <= t - s) && "bottom";
            var r = null == this.affixed,
                l = r ? a : o.top,
                h = r ? n : e;
            return null != i && a <= i ? "top" : null != s && l + h >= t - s && "bottom"
    ...
    function (t) {
        ...
        function e(e) {
            return this.each(function () {
                var s = t(this),
                    a = s.data("bs.button"),
                    o = "object" == typeof e && e;
                a || s.data("bs.button", a = new i(this, o)), "toggle" == e ? a.toggle() : e && a.setState(e)
            })
        }
        var i = function (e, s) {
        ...
        i.VERSION = "3.3.5", i.DEFAULTS = {
            ...
            e += "Text", null == o.resetText && s.data("resetText", s[a]()), setTimeout(t.proxy(function () {
                s[a](null == o[e] ? this.options[e] : o[e]), "loadingText" == e ? (this.isLoading = !0, s.addClass(i).attr(i, i)) : this.isLoading && (this.isLoading = !1, s.removeClass(i).removeAttr(i))
            }, this), 0)
    ...
    function (t) {
        ...
        function e(e) {
            return this.each(function () {
                var s = t(this),
                    ...
                    n = "string" == typeof e ? e : o.slide;
                a || s.data("bs.carousel", a = new i(this, o)), "number" == typeof e ? a.to(e) : n ? a[n]() : o.interval && a.pause().cycle()
            })
        }
        var i = function (e, i) {
        ...
        i.VERSION = "3.3.5", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
            ...
            var a = this.$element.find(".item.active"),
                o = s || this.getItemForDirection(e, a),
                n = this.interval,
                r = "next" == e ? "left" : "right",
                l = this;
            ...
            if (this.$element.trigger(d), !d.isDefaultPrevented()) {
                ...
                }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (a.removeClass("active"), o.addClass("active"), this.sliding = !1, this.$element.trigger(p)), n && this.cycle(), this
            }
        };
        var s = t.fn.carousel;
        ...
        var a = function (i) {
            var s, a = t(this),
                o = t(a.attr("data-target") || (s = a.attr("href")) && s.replace(/.*(?=#[^\s]+$)/, ""));
            if (o.hasClass("carousel")) {
                var n = t.extend({}, o.data(), a.data()),
                    r = a.attr("data-slide-to");
                r && (n.interval = !1), e.call(o, n), r && o.data("bs.carousel").to(r), i.preventDefault()
            }
        };
    ...
    function (t) {
        ...
        function i(e) {
            return this.each(function () {
                ...
                !a && o.toggle && /show|hide/.test(e) && (o.toggle = !1), a || i.data("bs.collapse", a = new s(this, o)), "string" == typeof e && a[e]()
            })
        }
        var s = function (e, i) {
        ...
        s.VERSION = "3.3.5", s.TRANSITION_DURATION = 350, s.DEFAULTS = {
            ...
            if (!this.transitioning && !this.$element.hasClass("in")) {
                ...
                if (!(a && a.length && (e = a.data("bs.collapse")) && e.transitioning)) {
                    ...
                    if (this.$element.trigger(o), !o.isDefaultPrevented()) {
                        ...
                        this.$element.one("bsTransitionEnd", t.proxy(r, this)).emulateTransitionEnd(s.TRANSITION_DURATION)[n](this.$element[0][l])
                    }
                }
            }
            ...
            if (!this.transitioning && this.$element.hasClass("in")) {
                ...
                if (this.$element.trigger(e), !e.isDefaultPrevented()) {
                    ...
                    this.$element[i](0).one("bsTransitionEnd", t.proxy(a, this)).emulateTransitionEnd(s.TRANSITION_DURATION)
                }
            }
    ...
    function (t) {
        ...
        function i(i) {
            i && 3 === i.which || (t(a).remove(), t(o).each(function () {
                ...
                a.hasClass("open") && (i && "click" == i.type && /input|textarea/i.test(i.target.tagName) && t.contains(a[0], i.target) || (a.trigger(i = t.Event("hide.bs.dropdown", o)), i.isDefaultPrevented() || (s.attr("aria-expanded", "false"), a.removeClass("open").trigger("hidden.bs.dropdown", o))))
            }))
        }
        ...
        n.VERSION = "3.3.5", n.prototype.toggle = function (s) {
            ...
            if (/(38|40|27|32)/.test(i.which) && !/input|textarea/i.test(i.target.tagName)) {
                ...
                if (i.preventDefault(), i.stopPropagation(), !s.is(".disabled, :disabled")) {
                    var a = e(s),
                        n = a.hasClass("open");
                    if (!n && 27 != i.which || n && 27 == i.which) return 27 == i.which && a.find(o).trigger("focus"), s.trigger("click");
        ...
        var r = t.fn.dropdown;
        t.fn.dropdown = s, t.fn.dropdown.Constructor = n, t.fn.dropdown.noConflict = function () {
    ...
    function (t) {
        ...
        function e(e, s) {
            return this.each(function () {
                ...
                o || a.data("bs.modal", o = new i(this, n)), "string" == typeof e ? o[e](s) : n.show && o.show(s)
            })
        }
        var i = function (e, i) {
        ...
        t.fn.modal = e, t.fn.modal.Constructor = i, t.fn.modal.noConflict = function () {
            ...
            var s = t(this),
                a = s.attr("href"),
                o = t(s.attr("data-target") || a && a.replace(/.*(?=#[^\s]+$)/, "")),
    ...
    function (t) {
        ...
        function e(e) {
            return this.each(function () {
                var s = t(this),
                    a = s.data("bs.tooltip"),
                    o = "object" == typeof e && e;
                !a && /destroy|hide/.test(e) || (a || s.data("bs.tooltip", a = new i(this, o)), "string" == typeof e && a[e]())
            })
        }
        var i = function (t, e) {
        ...
        i.VERSION = "3.3.5", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
            ...
            for (var a = this.options.trigger.split(" "), o = a.length; o--;) {
                var n = a[o];
                if ("click" == n) this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this));
                else if ("manual" != n) {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                if (h) {
                    ...
                    r = "bottom" == r && d.bottom + p > f.bottom ? "top" : "top" == r && d.top - p < f.top ? "bottom" : "right" == r && d.right + c > f.width ? "left" : "left" == r && d.left - c < f.left ? "right" : r, o.removeClass(u).addClass(r)
                }
            ...
            isNaN(n) && (n = 0), isNaN(r) && (r = 0), e.top += n, e.left += r, t.offset.setOffset(s[0], t.extend({
                using: function (t) {
                    s.css({
            ...
            if (this.$element.trigger(n), !n.isDefaultPrevented()) return o.removeClass("in"), t.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", s).emulateTransitionEnd(i.TRANSITION_DURATION) : s(), this.hoverState = null, this
            ...
            if (/right|left/.test(t)) {
                var r = e.top - o - n.scroll,
                    l = e.top + o - n.scroll + s;
                r < n.top ? a.top = n.top - r : l > n.top + n.height && (a.top = n.top + n.height - l)
            } else {
                var h = e.left - o,
                    d = e.left + o + i;
                h < n.left ? a.left = n.left - h : d > n.right && (a.left = n.left + n.width - d)
            }
            return a
        ...
        function e(e) {
            return this.each(function () {
                var s = t(this),
                    a = s.data("bs.popover"),
                    o = "object" == typeof e && e;
                !a && /destroy|hide/.test(e) || (a || s.data("bs.popover", a = new i(this, o)), "string" == typeof e && a[e]())
            })
        }
        var i = function (t, e) {
    ...
    function (t) {
        ...
        function i(i) {
            return this.each(function () {
                var s = t(this),
                    ...
                    o = "object" == typeof i && i;
                a || s.data("bs.scrollspy", a = new e(this, o)), "string" == typeof i && a[i]()
            })
        }
        e.VERSION = "3.3.5", e.DEFAULTS = {
            ...
            var t, e = this.$scrollElement.scrollTop() + this.options.offset,
                ...
                o = this.targets,
                n = this.activeTarget;
            if (this.scrollHeight != i && this.refresh(), e >= s) return n != (t = o[o.length - 1]) && this.activate(t);
            if (n && e < a[0]) return this.activeTarget = null, this.clear();
            for (t = a.length; t--;) n != o[t] && e >= a[t] && (void 0 === a[t + 1] || e < a[t + 1]) && this.activate(o[t])
    ...
    function (t) {
        ...
        t(document).on("click", ".ajax-get", function () {
            var e, i = this;
            return !(t(this).hasClass("confirm") && !confirm("确认要执行该操作吗?")) && (((e = t(this).attr("href")) || (e = t(this).attr("url"))) && (t(this).addClass("disabled").attr("autocomplete", "off").prop("disabled", !0), t.ajax({
                dataType: "json",
                url: e,
                type: "get",
                success: function (e) {
                    if (void 0 == e.status) void 0 !== window.lingyun ? window.lingyun.app_debug ? alert(e) : window.lingyun.app_debug_msg ? alert(window.lingyun.app_debug_msg) : alert("调试模式已关闭") : alert(e), t(i).removeClass("disabled").prop("disabled", !1);
                    else if (1 == e.status) {
                        if (e.url && !t(i).hasClass("no-refresh")) var s = e.info + " 页面即将自动跳转~";
                        else var s = e.info;
                        t.alertMessager(s, "success", t(this).attr("alert-style")), setTimeout(function () {
                            if (t(i).removeClass("disabled").prop("disabled", !1), t(i).hasClass("no-refresh")) return !1;
                            e.url && !t(i).hasClass("no-forward") ? e.replace || t(i).hasClass("location-replace") ? location.replace(e.url) : location.href = e.url : location.reload()
                        }, 2e3)
                    } else 1 == e.login ? t("#login-modal").modal() : t.alertMessager(e.info, "danger", t(this).attr("alert-style")), setTimeout(function () {
                        t(i).removeClass("disabled").prop("disabled", !1)
                    }, 2e3)
                },
                error: function (e) {
                    e.responseText && (void 0 !== window.lingyun ? window.lingyun.app_debug ? alert(e.responseText) : window.lingyun.app_debug_msg ? alert(window.lingyun.app_debug_msg) : alert("调试模式已关闭") : alert(e.responseText)), t(i).removeClass("disabled").prop("disabled", !1)
                }
            })), !1)
        })
    }(jQuery),
    function (t) {
        ...
        t(document).on("click", ".ajax-post", function () {
            var e, i, s, a = t(this).attr("target-form"),
                o = this,
                n = !1;

            if ("submit" == t(this).attr("type") || (e = t(this).attr("href")) || (e = t(this).attr("url"))) {
                if (s = t("." + a), "true" === t(this).attr("hide-data")) s = t(".hide-data"), i = s.serialize();
                else {
                    if (void 0 == s.get(0)) return !1;
                    if ("FORM" == s.get(0).nodeName) {
                        if (t(this).hasClass("confirm") && !confirm("确认要执行该操作吗?")) return !1;
                        e = void 0 !== t(this).attr("href") ? t(this).attr("href") : void 0 !== t(this).attr("url") ? t(this).attr("url") : s.get(0).action, i = s.serialize()
                    } else if ("INPUT" == s.get(0).nodeName || "SELECT" == s.get(0).nodeName || "TEXTAREA" == s.get(0).nodeName) {
                        if (s.each(function (t, e) {
                                "checkbox" == e.type && 1 == e.checked && (n = !0)
                            }), n && t(this).hasClass("confirm") && !confirm("确认要执行该操作吗?")) return !1;
                        i = s.serialize()
                    } else {
                        if (t(this).hasClass("confirm") && !confirm("确认要执行该操作吗?")) return !1;
                        i = s.find("input,select,textarea").serialize()
                    }
                }
                t(o).addClass("disabled").attr("autocomplete", "off").prop("disabled", !0), t.ajax({
                    dataType: "json",
                    url: e,
                    data: i,
                    type: "post",
                    success: function (e) {
                        ...
                        if (void 0 == e.status) console.log(window.lingyun), void 0 !== window.lingyun ? window.lingyun.app_debug ? alert(e) : window.lingyun.app_debug_msg ? alert(window.lingyun.app_debug_msg) : alert("调试模式已关闭") : alert(e), t(o).removeClass("disabled").prop("disabled", !1);
                        else if (1 == e.status) {
                            if (e.url && !t(o).hasClass("no-refresh")) var i = e.info + " 页面即将自动跳转~";
                            else var i = e.info;
                            t.alertMessager(i, "success", t(this).attr("alert-style")), setTimeout(function () {
                                if (t(o).hasClass("no-refresh")) return !1;
                                e.url && !t(o).hasClass("no-forward") ? e.replace || t(o).hasClass("location-replace") ? location.replace(e.url) : location.href = e.url : location.reload()
                            }, 2e3)
                        } else t.alertMessager(e.info, "danger", t(this).attr("alert-style")), setTimeout(function () {
                            t(o).removeClass("disabled").prop("disabled", !1)
                        }, 2e3), t(".reload-verify").length > 0 && t(".reload-verify").click()
                    },
                    error: function (e) {
                        e.responseText && (void 0 !== window.lingyun ? window.lingyun.app_debug ? alert(e.responseText) : window.lingyun.app_debug_msg ? alert(window.lingyun.app_debug_msg) : alert("调试模式已关闭") : alert(e.responseText)), t(o).removeClass("disabled").prop("disabled", !1)
                    }
                })
            }
            return !1
    ...
    function (t) {
        ...
        var i = function (e, i) {
            ...
            for (var n = 3 === this.bootcssVer ? o.templateV3 : o.template; - 1 !== n.indexOf("{iconType}");) n = n.replace("{iconType}", this.icontype);
            ...
            if (this.picker = t(n).appendTo(this.isInline ? this.element : this.container).on({
        ...
        i.prototype = {
            ...
            place: function () {
                if (!this.isInline) {
                    ...
                    var i, s, a, o;
                    o = this.container instanceof t ? this.container.offset() : t(this.container).offset(), this.component ? (i = this.component.offset(), a = i.left, "bottom-left" != this.pickerPosition && "top-left" != this.pickerPosition || (a += this.component.outerWidth() - this.picker.outerWidth())) : (i = this.element.offset(), a = i.left);
                    var n = document.body.clientWidth || window.innerWidth;
                    a + 220 > n && (a = n - 220), s = "top-left" == this.pickerPosition || "top-right" == this.pickerPosition ? i.top - this.picker.outerHeight() : i.top + this.height, s -= o.top, a -= o.left, this.picker.css({
                        top: s,
                        left: a,
                        zIndex: this.zIndex
                    })
            ...
            fillMonths: function () {
                for (var t = "", e = 0; e < 12;) t += '<span class="month">' + a[this.language].monthsShort[e++] + "</span>";
            ...
            fill: function () {
                if (null != this.date && null != this.viewDate) {
                    var i = new Date(this.viewDate),
                        ...
                        m = new Date;
                    if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(a[this.language].months[n] + " " + s), "time" == this.formatViewType) {
                    ...
                    } else this.picker.find(".datetimepicker-hours thead th:eq(1)").text(r + " " + a[this.language].months[n] + " " + s), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(r + " " + a[this.language].months[n] + " " + s);
                    this.picker.find("tfoot th.today").text(a[this.language].today).toggle(!1 !== this.todayBtn), this.updateNavArrows(), this.fillMonths();
                    var v = e(s, n - 1, 28, 0, 0, 0, 0),
                        w = o.getDaysInMonth(v.getUTCFullYear(), v.getUTCMonth());
                    v.setUTCDate(w), v.setUTCDate(w - (v.getUTCDay() - this.weekStart + 7) % 7);
                    var y = new Date(v);
                    y.setUTCDate(y.getUTCDate() + 42), y = y.valueOf();
                    for (var b, T = []; v.valueOf() < y;) v.getUTCDay() == this.weekStart && T.push("<tr>"), b = "", v.getUTCFullYear() < s || v.getUTCFullYear() == s && v.getUTCMonth() < n ? b += " old" : (v.getUTCFullYear() > s || v.getUTCFullYear() == s && v.getUTCMonth() > n) && (b += " new"), this.todayHighlight && v.getUTCFullYear() == m.getFullYear() && v.getUTCMonth() == m.getMonth() && v.getUTCDate() == m.getDate() && (b += " today"), v.valueOf() == f && (b += " active"), (v.valueOf() + 864e5 <= this.startDate || v.valueOf() > this.endDate || -1 !== t.inArray(v.getUTCDay(), this.daysOfWeekDisabled)) && (b += " disabled"), T.push('<td class="day' + b + '">' + v.getUTCDate() + "</td>"), v.getUTCDay() == this.weekEnd && T.push("</tr>"), v.setUTCDate(v.getUTCDate() + 1);
                    this.picker.find(".datetimepicker-days tbody").empty().append(T.join("")), T = [];
                    for (var D = "", C = "", k = "", x = this.hoursDisabled || [], I = 0; I < 24; I++)
                        if (-1 === x.indexOf(I)) {
                            var $ = e(s, n, r, I);
                            b = "", $.valueOf() + 36e5 <= this.startDate || $.valueOf() > this.endDate ? b += " disabled" : l == I && (b += " active"), this.showMeridian && 2 == a[this.language].meridiem.length ? (C = I < 12 ? a[this.language].meridiem[0] : a[this.language].meridiem[1], C != k && ("" != k && T.push("</fieldset>"), T.push('<fieldset class="hour"><legend>' + C.toUpperCase() + "</legend>")), k = C, D = I % 12 ? I % 12 : 12, T.push('<span class="hour' + b + " hour_" + (I < 12 ? "am" : "pm") + '">' + D + "</span>"), 23 == I && T.push("</fieldset>")) : (D = I + ":00", T.push('<span class="hour' + b + '">' + D + "</span>"))
                        }
                    this.picker.find(".datetimepicker-hours td").html(T.join("")), T = [], D = "", C = "", k = "";
                    for (var M = this.minutesDisabled || [], I = 0; I < 60; I += this.minuteStep)
                        if (-1 === M.indexOf(I)) {
                            var $ = e(s, n, r, l, I, 0);
                            b = "", $.valueOf() < this.startDate || $.valueOf() > this.endDate ? b += " disabled" : Math.floor(h / this.minuteStep) == Math.floor(I / this.minuteStep) && (b += " active"), this.showMeridian && 2 == a[this.language].meridiem.length ? (C = l < 12 ? a[this.language].meridiem[0] : a[this.language].meridiem[1], C != k && ("" != k && T.push("</fieldset>"), T.push('<fieldset class="minute"><legend>' + C.toUpperCase() + "</legend>")), k = C, D = l % 12 ? l % 12 : 12, T.push('<span class="minute' + b + '">' + D + ":" + (I < 10 ? "0" + I : I) + "</span>"), 59 == I && T.push("</fieldset>")) : (D = I + ":00", T.push('<span class="minute' + b + '">' + l + ":" + (I < 10 ? "0" + I : I) + "</span>"))
                        }
                    this.picker.find(".datetimepicker-minutes td").html(T.join(""));
                    var S = this.date.getUTCFullYear(),
                        U = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(s).end().find("span").removeClass("active");
                    if (S == s) {
                        var _ = U.length - 12;
                        U.eq(this.date.getUTCMonth() + _).addClass("active")
                    }(s < d || s > p) && U.addClass("disabled"), s == d && U.slice(0, c + 1).addClass("disabled"), s == p && U.slice(u).addClass("disabled"), T = "", s = 10 * parseInt(s / 10, 10);
                    var A = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(s + "-" + (s + 9)).end().find("td");
                    s -= 1;
                    for (var I = -1; I < 11; I++) T += '<span class="year' + (-1 == I || 10 == I ? " old" : "") + (S == s ? " active" : "") + (s < d || s > p ? " disabled" : "") + '">' + s + "</span>", s += 1;
                    A.html(T), this.place()
                }
            },
                    ...
                    switch (s[0].nodeName.toLowerCase()) {
                        case "th":
                            switch (s[0].className) {
                                ...
                                case "prev":
                                case "next":
                                    var a = o.modes[this.viewMode].navStep * ("prev" == s[0].className ? -1 : 1);
                                    switch (this.viewMode) {
                                        case 0:
                                ...
                                case "today":
                                    var n = new Date;
                                    n = e(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds(), 0), n < this.startDate ? n = this.startDate : n > this.endDate && (n = this.endDate), this.viewMode = this.startViewMode, this.showMode(0), this._setDate(n), this.fill(), this.autoclose && this.hide()
                            }
                            break;
                        case "span":
                            if (!s.is(".disabled")) {
                                ...
                                if (s.is(".month") ? (this.viewDate.setUTCDate(1), l = s.parent().find("span").index(s), h = this.viewDate.getUTCDate(), this.viewDate.setUTCMonth(l), this.element.trigger({
                                        type: "changeMonth",
                                        date: this.viewDate
                                    }), this.viewSelect >= 3 && this._setDate(e(r, l, h, d, c, p, 0))) : s.is(".year") ? (this.viewDate.setUTCDate(1), r = parseInt(s.text(), 10) || 0, this.viewDate.setUTCFullYear(r), this.element.trigger({
                                        type: "changeYear",
                                        date: this.viewDate
                                    }), this.viewSelect >= 4 && this._setDate(e(r, l, h, d, c, p, 0))) : s.is(".hour") ? (d = parseInt(s.text(), 10) || 0, (s.hasClass("hour_am") || s.hasClass("hour_pm")) && (12 == d && s.hasClass("hour_am") ? d = 0 : 12 != d && s.hasClass("hour_pm") && (d += 12)), this.viewDate.setUTCHours(d), this.element.trigger({
                                        type: "changeHour",
                                        date: this.viewDate
                                    }), this.viewSelect >= 1 && this._setDate(e(r, l, h, d, c, p, 0))) : s.is(".minute") && (c = parseInt(s.text().substr(s.text().indexOf(":") + 1), 10) || 0, this.viewDate.setUTCMinutes(c), this.element.trigger({
                                        type: "changeMinute",
                                        date: this.viewDate
                                    }), this.viewSelect >= 0 && this._setDate(e(r, l, h, d, c, p, 0))), 0 != this.viewMode) {
                                    var u = this.viewMode;
                        ...
                        case "td":
                            if (s.is(".day") && !s.is(".disabled")) {
                                var h = parseInt(s.text(), 10) || 1,
                                    ...
                                    c = this.viewDate.getUTCMinutes(),
                                    p = this.viewDate.getUTCSeconds();
                                s.is(".old") ? 0 === l ? (l = 11, r -= 1) : l -= 1 : s.is(".new") && (11 == l ? (l = 0, r += 1) : l += 1), this.viewDate.setUTCFullYear(r), this.viewDate.setUTCMonth(l, h), this.element.trigger({
                                    type: "changeDay",
                                    date: this.viewDate
                                }), this.viewSelect >= 2 && this._setDate(e(r, l, h, d, c, p, 0))
                            }
                            var u = this.viewMode;
                            this.showMode(-1), this.fill(), u == this.viewMode && this.autoclose && this.hide()
                    }
            ...
            moveMonth: function (t, e) {
                ...
                }, i = n + e, a.setUTCMonth(i), (i < 0 || i > 11) && (i = (i + 12) % 12);
                else {
                    for (var l = 0; l < r; l++) a = this.moveMonth(a, e);
                    i = a.getUTCMonth(), a.setUTCDate(o), s = function () {
                        return i != a.getUTCMonth()
                    }
                }
                for (; s();) a.setUTCDate(--o), a.setUTCMonth(i);
                return a
            },
            ...
            keydown: function (t) {
                ...
                switch (t.keyCode) {
                    ...
                    case 39:
                        ...
                        e = 37 == t.keyCode ? -1 : 1, viewMode = this.viewMode, t.ctrlKey ? viewMode += 2 : t.shiftKey && (viewMode += 1), 4 == viewMode ? (i = this.moveYear(this.date, e), s = this.moveYear(this.viewDate, e)) : 3 == viewMode ? (i = this.moveMonth(this.date, e),
        ...
        t.fn.datetimepicker = function (e) {
            ...
            return this.each(function () {
                var o = t(this),
                    ...
                    r = "object" == typeof e && e;
                if (n || o.data("datetimepicker", n = new i(this, t.extend({}, t.fn.datetimepicker.defaults, r))), "string" == typeof e && "function" == typeof n[e] && void 0 !== (a = n[e].apply(n, s))) return !1
            }), void 0 !== a ? a : this
        ...
        var a = t.fn.datetimepicker.dates = {
            ...
            o = {
                ...
                parseDate: function (s, o, n, r) {
                    if (s instanceof Date) {
                        var l = new Date(s.valueOf() - 6e4 * s.getTimezoneOffset());
                        return l.setMilliseconds(0), l
                    }
                    if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(s) && (o = this.parseFormat("yyyy-mm-dd", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(s) && (o = this.parseFormat("yyyy-mm-dd hh:ii", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(s) && (o = this.parseFormat("yyyy-mm-dd hh:ii:ss", r)), /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(s)) {
                        var h, d, c = /([-+]\d+)([dmwy])/,
                            p = s.match(/([-+]\d+)([dmwy])/g);
                        s = new Date;
                        for (var u = 0; u < p.length; u++) switch (h = c.exec(p[u]), d = parseInt(h[1]), h[2]) {
                            case "d":
                    ...
                    var f, m, h, p = s && s.toString().match(this.nonpunctuation) || [],
                    ...
                    if (w.M = w.MM = w.mm = w.m, w.dd = w.d, w.P = w.p, s = e(s.getFullYear(), s.getMonth(), s.getDate(), s.getHours(), s.getMinutes(), s.getSeconds()), p.length == o.parts.length) {
                        for (var u = 0, y = o.parts.length; u < y; u++) {
                            if (f = parseInt(p[u], 10), h = o.parts[u], isNaN(f)) switch (h) {
                                case "MM":
                                    m = t(a[n].months).filter(function () {
                                        var t = this.slice(0, p[u].length);
                                        return t == p[u].slice(0, t.length)
                                    }), f = t.inArray(m[0], a[n].months) + 1;
                                    break;
                                case "M":
                                    m = t(a[n].monthsShort).filter(function () {
                                        var t = this.slice(0, p[u].length),
                                            e = p[u].slice(0, t.length);
                                        return t.toLowerCase() == e.toLowerCase()
                                    }), f = t.inArray(m[0], a[n].monthsShort) + 1;
                                    break;
                                case "p":
                                case "P":
                                    f = t.inArray(p[u].toLowerCase(), a[n].meridiem)
                            }
                            g[h] = f
                        }
                        for (var b, u = 0; u < v.length; u++)(b = v[u]) in g && !isNaN(g[b]) && w[b](s, g[b])
                    }
                    return s
                },
                formatDate: function (e, i, s, n) {
                    if (null == e) return "";
                    var r;
                    if ("standard" == n) r = {
                        ...
                        i: e.getUTCMinutes(),
                        s: e.getUTCSeconds()
                    }, 2 == a[s].meridiem.length ? r.H = r.h % 12 == 0 ? 12 : r.h % 12 : r.H = r.h, r.HH = (r.H < 10 ? "0" : "") + r.H, r.P = r.p.toUpperCase(), r.hh = (r.h < 10 ? "0" : "") + r.h, r.ii = (r.i < 10 ? "0" : "") + r.i, r.ss = (r.s < 10 ? "0" : "") + r.s, r.dd = (r.d < 10 ? "0" : "") + r.d, r.mm = (r.m < 10 ? "0" : "") + r.m;
                    else {
                    ...
                    for (var e = [], l = t.extend([], i.separators), h = 0, d = i.parts.length; h < d; h++) l.length && e.push(l.shift()), e.push(r[i.parts[h]]);
    ...
    function (t) {
        "use strict";
        t.alertMessager = function (e, i, s) {
            i = i || "danger";
            var a = '<div class="growl" style="top: 50px;left: 0;right:0;margin:0 auto;"><div class="alert alert-full alert-dismissable alert-' + i + '"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>' + e + "</div></div>";
            t(".growl").remove(), t("body").prepend(a), setTimeout(function () {
                t(".growl").remove()
            }, s || 2e3)
        }
    }(jQuery),
    function (t) {
        ...
        function e(e) {
            return this.each(function () {
                var s = t(this),
                    a = s.data("bs.image-grid"),
                    o = t.extend({}, i.DEFAULTS, s.data(), "object" == typeof e && e);
                a || s.data("bs.image-grid", a = new i(this, o)), "string" == typeof e && a[e].call(s)
            })
        }
        var i = function (e, s) {
            this.cleanWhitespace(e), this.row = 0, this.rownum = 1, this.elements = [], this.element = e, this.albumWidth = t(e).width(), this.images = t(e).children(), this.options = t.extend({}, i.DEFAULTS, s), t(window).on("resize", t.proxy(this.handleResize, this)), this.processImages()
        };
        i.VERSION = "3.3.1", i.TRANSITION_DURATION = 350, i.DEFAULTS = {
            ...
            this.images.each(function (i) {
                var s = t(this),
                    a = s.is("img") ? s : s.find("img"),
                    o = void 0 !== a.data("width") ? a.data("width") : a.width(),
                    n = void 0 !== a.data("height") ? a.data("height") : a.height();
                a.data("width", o), a.data("height", n);
                var r = Math.ceil(o / n * e.options.targetHeight),
            ...
            for (var i = this.options.padding * (this.elements.length - 1), s = this.albumWidth - i, a = s / (e - i), o = i, n = (this.albumWidth, 0); n < this.elements.length; n++) {
                var r = t(this.elements[n][0]),
                    l = Math.floor(this.elements[n][1] * a),
                    h = Math.floor(this.elements[n][2] * a),
                    d = n < this.elements.length - 1;
                o += l, !d && o < this.albumWidth && (l += this.albumWidth - o), l--;
        ...
        t.fn.citySelect = function (e) {
            if (!(this.length < 1)) {
                ...
                var i, s = this,
                    ...
                    o = s.find(".city"),
                    n = s.find(".dist"),
                    r = (e.prov, e.city, e.dist, e.required ? "" : "<option value=''>请选择</option>"),
                    l = function () {
                        var s = a.get(0).selectedIndex;
                        if (e.required || s--, o.empty().attr("disabled", !0), n.empty().attr("disabled", !0), s < 0 || void 0 === i.citylist[s].c) return void("none" == e.nodata ? (o.css("display", "none"), n.css("display", "none")) : "hidden" == e.nodata && (o.css("visibility", "hidden"), n.css("visibility", "hidden")));
                        temp_html = r, t.each(i.citylist[s].c, function (t, e) {
                            e.n.key ? temp_html += "<option value='" + e.n.key + "'>" + e.n.value + "</option>" : temp_html += "<option value='" + e.n + "'>" + e.n + "</option>"
                        }), o.html(temp_html).attr("disabled", !1).css({
                            display: "",
                            visibility: ""
                        }), h()
                    },
                    h = function () {
                        var s = a.get(0).selectedIndex,
                            l = o.get(0).selectedIndex;
                        if (e.required || (s--, l--), n.empty().attr("disabled", !0), s < 0 || l < 0 || void 0 === i.citylist[s].c[l].a) return void("none" == e.nodata ? n.css("display", "none") : "hidden" == e.nodata && n.css("visibility", "hidden"));
                        temp_html = r, t.each(i.citylist[s].c[l].a, function (t, e) {
                            e.s.key ? temp_html += "<option value='" + e.s.key + "'>" + e.s.value + "</option>" : temp_html += "<option value='" + e.s + "'>" + e.s + "</option>"
                        }), n.html(temp_html).attr("disabled", !1).css({
                            display: "",
                            visibility: ""
                        })
                    },
                    d = function () {
                        temp_html = r, t.each(i.citylist, function (t, e) {
                            e.p.key ? temp_html += "<option value='" + e.p.key + "'>" + e.p.value + "</option>" : temp_html += "<option value='" + e.p + "'>" + e.p + "</option>"
                        }), a.html(temp_html), setTimeout(function () {
                            null != e.prov && (a.val(e.prov), l(), setTimeout(function () {
                                null != e.city && (o.val(e.city), h(), setTimeout(function () {
                                    null != e.dist && n.val(e.dist)
                                }, 1))
                            }, 1))
                        }, 1), a.bind("change", function () {
                            l()
                        }), o.bind("change", function () {
                            h()
                        })
                    };
                "string" == typeof e.url ? t.getJSON(e.url, function (t) {
                    i = t, d()
                }) : (i = e.url, d())
            }
        }
    ...
    function (t) {
        ...
        var n = /\+/g,
            r = t.cookie = function (a, n, l) {
                if (void 0 !== n && !t.isFunction(n)) {
                    if (l = t.extend({}, r.defaults, l), "number" == typeof l.expires) {
                        var h = l.expires,
                            d = l.expires = new Date;
                        d.setTime(+d + 864e5 * h)
                    }
                    return document.cookie = [e(a), "=", s(n), l.expires ? "; expires=" + l.expires.toUTCString() : "", l.path ? "; path=" + l.path : "", l.domain ? "; domain=" + l.domain : "", l.secure ? "; secure" : ""].join("")
                }
                for (var c = a ? void 0 : {}, p = document.cookie ? document.cookie.split("; ") : [], u = 0, f = p.length; u < f; u++) {
                    var m = p[u].split("="),
                        g = i(m.shift()),
                        v = m.join("=");
                    if (a && a === g) {
    ...
    function (t) {
        t.fn.dragsort = function (e) {
            ...
            var i = t.extend({}, t.fn.dragsort.defaults, e),
                s = [],
                a = null,
                o = null;
            return this.each(function (e, n) {
                t(n).is("table") && 1 == t(n).children().size() && t(n).children().is("tbody") && (n = t(n).children().get(0));
                var r = {
                    draggedItem: null,
                    ...
                    container: n,
                    init: function () {
                        i.tagName = 0 == t(this.container).children().size() ? "li" : t(this.container).children().get(0).tagName.toLowerCase(), "" == i.itemSelector && (i.itemSelector = i.tagName), "" == i.dragSelector && (i.dragSelector = i.tagName), "" == i.placeHolderTemplate && (i.placeHolderTemplate = "<" + i.tagName + ">&nbsp;</" + i.tagName + ">"), t(this.container).attr("data-listidx", e).mousedown(this.grabItem).bind("dragsort-uninit", this.uninit), this.styleDragHandlers(!0)
                    },
                    uninit: function () {
                        var e = s[t(this).attr("data-listidx")];
                        t(e.container).unbind("mousedown", e.grabItem).unbind("dragsort-uninit"), e.styleDragHandlers(!1)
                    },
                    getItems: function () {
                        return t(this.container).children(i.itemSelector)
                    },
                    styleDragHandlers: function (e) {
                        this.getItems().map(function () {
                            return t(this).is(i.dragSelector) ? this : t(this).find(i.dragSelector).get()
                        }).css("cursor", e ? "pointer" : "")
                    },
                    grabItem: function (e) {
                        var a = s[t(this).attr("data-listidx")],
                            o = t(e.target).closest("[data-listidx] > " + i.tagName).get(0),
                            n = a.getItems().filter(function () {
                                return this == o
                            }).size() > 0;
                        if (!(1 != e.which || t(e.target).is(i.dragSelectorExclude) || t(e.target).closest(i.dragSelectorExclude).size() > 0) && n) {
                            e.preventDefault();
                            for (var r = e.target; !t(r).is(i.dragSelector);) {
                                if (r == this) return;
                                r = r.parentNode
                            }
                            t(r).attr("data-cursor", t(r).css("cursor")), t(r).css("cursor", "move");
                            var l = this,
                                h = function () {
                                    a.dragStart.call(l, e), t(a.container).unbind("mousemove", h)
                                };
                            t(a.container).mousemove(h).mouseup(function () {
                                t(a.container).unbind("mousemove", h), t(r).css("cursor", t(r).attr("data-cursor"))
                            })
                        }
                    },
                    dragStart: function (e) {
                        if (null != a && null != a.draggedItem && a.dropItem(), a = s[t(this).attr("data-listidx")], a.draggedItem = t(e.target).closest("[data-listidx] > " + i.tagName), !1 === i.dragStart.apply(a.draggedItem)) return void(a.draggedItem = null);
                        a.draggedItem.attr("data-origpos", t(this).attr("data-listidx") + "-" + t(a.container).children().index(a.draggedItem));
                        var o = parseInt(a.draggedItem.css("marginTop")),
                            n = parseInt(a.draggedItem.css("marginLeft"));
                        if (a.offset = a.draggedItem.offset(), a.offset.top = e.pageY - a.offset.top + (isNaN(o) ? 0 : o) - 1, a.offset.left = e.pageX - a.offset.left + (isNaN(n) ? 0 : n) - 1, !i.dragBetween) {
                            var r = 0 == t(a.container).outerHeight() ? Math.max(1, Math.round(.5 + a.getItems().size() * a.draggedItem.outerWidth() / t(a.container).outerWidth())) * a.draggedItem.outerHeight() : t(a.container).outerHeight();
                            a.offsetLimit = t(a.container).offset(), a.offsetLimit.right = a.offsetLimit.left + t(a.container).outerWidth() - a.draggedItem.outerWidth(), a.offsetLimit.bottom = a.offsetLimit.top + r - a.draggedItem.outerHeight()
                        }
                        var l = a.draggedItem.height(),
                            h = a.draggedItem.width();
                        if ("tr" == i.tagName ? (a.draggedItem.children().each(function () {
                            ...
                            })) : (a.draggedItem.after(i.placeHolderTemplate), a.placeHolderItem = a.draggedItem.next().css({
                                height: l,
                                width: h
                            }).attr("data-placeholder", !0)), "td" == i.tagName) {
                            var d = a.draggedItem.closest("table").get(0);
                            t("<table id='" + d.id + "' style='border-width: 0px;' class='dragSortItem " + d.className + "'><tr></tr></table>").appendTo("body").children().append(a.draggedItem)
                        }
                        var c = a.draggedItem.attr("style");
                        a.draggedItem.attr("data-origstyle", c || ""), a.draggedItem.css({
                            position: "absolute",
                            opacity: .8,
                            "z-index": 999,
                            height: l,
                            ...
                            if (i.scrollContainer != window) return void t(i.scrollContainer).scrollTop(t(i.scrollContainer).scrollTop() + a.scroll.moveY);
                            var e = t(i.scrollContainer).scrollTop();
                            (a.scroll.moveY > 0 && e < a.scroll.maxY || a.scroll.moveY < 0 && e > 0) && (t(i.scrollContainer).scrollTop(e + a.scroll.moveY), a.draggedItem.css("top", a.draggedItem.offset().top + a.scroll.moveY + 1))
                        }, 10), a.scroll.scrollX = window.setInterval(function () {
                            if (i.scrollContainer != window) return void t(i.scrollContainer).scrollLeft(t(i.scrollContainer).scrollLeft() + a.scroll.moveX);
                            var e = t(i.scrollContainer).scrollLeft();
                            (a.scroll.moveX > 0 && e < a.scroll.maxX || a.scroll.moveX < 0 && e > 0) && (t(i.scrollContainer).scrollLeft(e + a.scroll.moveX), a.draggedItem.css("left", a.draggedItem.offset().left + a.scroll.moveX + 1))
                        }, 10), t(s).each(function (t, e) {
                            e.createDropTargets(), e.buildPositionTable()
                        }), a.setPos(e.pageX, e.pageY), t(document).bind("mousemove", a.swapItems), t(document).bind("mouseup", a.dropItem), i.scrollContainer != window && t(window).bind("DOMMouseScroll mousewheel", a.wheel)
                    },
                    setPos: function (e, s) {
                        var o = s - this.offset.top,
                            n = e - this.offset.left;
                        i.dragBetween || (o = Math.min(this.offsetLimit.bottom, Math.max(o, this.offsetLimit.top)), n = Math.min(this.offsetLimit.right, Math.max(n, this.offsetLimit.left)));
                        var r = this.draggedItem.offsetParent().not("body").offset();
                        if (null != r && (o -= r.top, n -= r.left), i.scrollContainer == window) s -= t(window).scrollTop(), e -= t(window).scrollLeft(), s = Math.max(0, s - t(window).height() + 5) + Math.min(0, s - 5), e = Math.max(0, e - t(window).width() + 5) + Math.min(0, e - 5);
                        else {
                            var l = t(i.scrollContainer),
                                h = l.offset();
                            s = Math.max(0, s - l.height() - h.top) + Math.min(0, s - h.top), e = Math.max(0, e - l.width() - h.left) + Math.min(0, e - h.left)
                        }
                        a.scroll.moveX = 0 == e ? 0 : e * i.scrollSpeed / Math.abs(e), a.scroll.moveY = 0 == s ? 0 : s * i.scrollSpeed / Math.abs(s), this.draggedItem.css({
                            top: o,
                            left: n
                        })
                    },
                    wheel: function (e) {
                        if ((t.browser.safari || t.browser.mozilla) && a && i.scrollContainer != window) {
                            var s = t(i.scrollContainer),
                                o = s.offset();
                            if (e.pageX > o.left && e.pageX < o.left + s.width() && e.pageY > o.top && e.pageY < o.top + s.height()) {
                                var n = e.detail ? 5 * e.detail : e.wheelDelta / -2;
                                s.scrollTop(s.scrollTop() + n), e.preventDefault()
                            }
                        }
                    },
                    buildPositionTable: function () {
                        var e = [];
                        this.getItems().not([a.draggedItem[0], a.placeHolderItem[0]]).each(function (i) {
                            var s = t(this).offset();
                            s.right = s.left + t(this).outerWidth(), s.bottom = s.top + t(this).outerHeight(), s.elm = this, e[i] = s
                        }), this.pos = e
                    },
                    dropItem: function () {
                        if (null != a.draggedItem) {
                            var e = a.draggedItem.attr("data-origstyle");
                            if (a.draggedItem.attr("style", e), "" == e && a.draggedItem.removeAttr("style"), a.draggedItem.removeAttr("data-origstyle"), a.styleDragHandlers(!0), a.placeHolderItem.before(a.draggedItem), a.placeHolderItem.remove(), t("[data-droptarget], .dragSortItem").remove(), window.clearInterval(a.scroll.scrollY), window.clearInterval(a.scroll.scrollX), a.draggedItem.attr("data-origpos") != t(s).index(a) + "-" + t(a.container).children().index(a.draggedItem) && 0 == i.dragEnd.apply(a.draggedItem)) {
                                var o = a.draggedItem.attr("data-origpos").split("-"),
                                    n = t(s[o[0]].container).children().not(a.draggedItem).eq(o[1]);
                                n.size() > 0 ? n.before(a.draggedItem) : 0 == o[1] ? t(s[o[0]].container).prepend(a.draggedItem) : t(s[o[0]].container).append(a.draggedItem)
                            }
                            return a.draggedItem.removeAttr("data-origpos"), a.draggedItem = null, t(document).unbind("mousemove", a.swapItems), t(document).unbind("mouseup", a.dropItem), i.scrollContainer != window && t(window).unbind("DOMMouseScroll mousewheel", a.wheel), !1
                        }
                    },
                    swapItems: function (e) {
                        if (null == a.draggedItem) return !1;
                        a.setPos(e.pageX, e.pageY);
                        for (var n = a.findPos(e.pageX, e.pageY), r = a, l = 0; - 1 == n && i.dragBetween && l < s.length; l++) n = s[l].findPos(e.pageX, e.pageY), r = s[l];
                        if (-1 == n) return !1;
                        var h = function () {
                                return t(r.container).children().not(r.draggedItem)
                            },
                            d = h().not(i.itemSelector).each(function (t) {
                                this.idx = h().index(this)
                            });
                        return null == o || o.top > a.draggedItem.offset().top || o.left > a.draggedItem.offset().left ? t(r.pos[n].elm).before(a.placeHolderItem) : t(r.pos[n].elm).after(a.placeHolderItem), d.each(function () {
                            var e = h().eq(this.idx).get(0);
                            this != e && h().index(this) < this.idx ? t(this).insertAfter(e) : this != e && t(this).insertBefore(e)
                        }), t(s).each(function (t, e) {
                            e.createDropTargets(), e.buildPositionTable()
                        }), o = a.draggedItem.offset(), !1
                    },
                    findPos: function (t, e) {
                        for (var i = 0; i < this.pos.length; i++)
                            if (this.pos[i].left < t && this.pos[i].right > t && this.pos[i].top < e && this.pos[i].bottom > e) return i;
                        return -1
                    },
                    createDropTargets: function () {
                        i.dragBetween && t(s).each(function () {
                            var e = t(this.container).find("[data-placeholder]"),
                                s = t(this.container).find("[data-droptarget]");
                            e.size() > 0 && s.size() > 0 ? s.remove() : 0 == e.size() && 0 == s.size() && ("td" == i.tagName ? t(i.placeHolderTemplate).attr("data-droptarget", !0).appendTo(this.container) : t(this.container).append(a.placeHolderItem.removeAttr("data-placeholder").clone().attr("data-droptarget", !0)), a.placeHolderItem.attr("data-placeholder", !0))
                        })
                    }
                };
                r.init(), s.push(r)
    ...
    function ($) {
        $.fn.iconpicker = function (options) {
            ...
            return this.buttonSize = "sm", this.columns = 10, this.height = 400, this.extend(options), this.open = !1, this.allowedSizes = ["sm", "lg", "2x", "3x", "4x", "5x"], this.templates = {
            ...
            }, this.icons = options.icons, $(this).on("click", function (t) {
                self.$el = $(t.currentTarget), $(t.currentTarget).find(".icon-menu").length ? self.closeMenu() : self.openMenu()
            }), $(this).on("click", ".icon", function (t) {
                t.stopPropagation();
                var e = $(t.currentTarget).data("icon");
                void 0 !== self.clickCallback ? self.clickCallback(e) : self.$el.find("> .form-control").val(e).focus().select(), self.closeMenu()
            }), $(this).on("click", ".icon-menu", function (t) {
                t.stopPropagation()
            }), $(this).on("keyup", ".icon-filter", function (t) {
                var e = $(t.target).val();
                self.doFilter(e)
            }), $(this).on("click", ".btn-group .btn", function (t) {
                var e = "sm" == $(t.currentTarget).data("size") ? "" : "fa-" + $(t.currentTarget).data("size");
                self.$sizeSelector.find(".btn").removeClass("active"), $(t.currentTarget).addClass("active"), self.$container.find("i").removeClass("fa-lg fa-2x fa-3x fa-4x fa-5x").addClass(e), self.resize()
            }), this.createMenu = function () {
                this.icons = eval(this.icons), this.$menu = $("<div>", {
                    class: "icon-menu",
                    style: "height:" + this.height + "px"
                }), !1 !== this.filter && (this.$filter = $(this.templates.filter), this.$menu.append(this.$filter)), !1 !== this.sizeSelector && (this.$sizeSelector = $(this.templates.sizes), this.$sizeSelector.find("a[data-size=" + this.buttonSize + "]").addClass("active"), this.$menu.append(this.$sizeSelector)), this.$container = $("<div>", {
                ...
                var e = Math.ceil($(".icon").outerWidth(!0) * this.columns + this.scrollbarWidth) + "px",
                    i = this.height - 2 * parseInt(this.$menu.css("padding-top"));
                i -= !1 !== this.filter ? this.$filter.outerHeight(!0) : 0, i -= !1 !== this.sizeSelector ? this.$sizeSelector.outerHeight(!0) : 0, this.$container.css({
                    width: e,
                    height: i
                })
            }, this.doFilter = function (t) {
                "" !== t ? ($(this).find("a.icon[data-filter*='" + t + "']").show(), $(this).find("a.icon:not([data-filter*='" + t + "'])").hide()) : $(this).find("a.icon").show()
            }, this.ucwords = function (t) {
                return (t.replace(/-/g, " ") + "").replace(/^([a-z\u00E0-\u00FC])|\s+([a-z\u00E0-\u00FC])/g, function (t) {
                    return t.toUpperCase()
                })
            }, this.sortObj = function (t) {
                var e, i, s = [],
                    a = {};
                for (e in t) s.push(e);
                for (s.sort(function (t, e) {
                    return t.toLowerCase().localeCompare(e.toLowerCase())
                }), i = 0; i < s.length; i++) a[s[i]] = t[s[i]];
                return a
            }, this.getScrollbarWidth = function () {
                var t = $('<div style="width: 100%; height:200px;">test</div>'),
                    e = $('<div style="width:200px;height:150px; position: absolute; top: 0; left: 0; visibility: hidden; overflow:hidden;"></div>').append(t),
                    i = t[0],
                    s = e[0];
                $("body").append(s);
                var a = i.offsetWidth;
    ...
    function (t, e, i, s) {
        ...
        t.fn.lazyload = function (s) {
            ...
            return s && (void 0 !== s.failurelimit && (s.failure_limit = s.failurelimit, delete s.failurelimit), void 0 !== s.effectspeed && (s.effect_speed = s.effectspeed, delete s.effectspeed), t.extend(l, s)), n = void 0 === l.container || l.container === e ? a : t(l.container), 0 === l.event.indexOf("scroll") && n.bind(l.event, function () {
                return o()
            }), this.each(function () {
                var e = this,
                    i = t(e);
            ...
            return (void 0 === s.container || s.container === e ? (e.innerHeight ? e.innerHeight : a.height()) + a.scrollTop() : t(s.container).offset().top + t(s.container).height()) <= t(i).offset().top - s.threshold
        }, t.rightoffold = function (i, s) {
            return (void 0 === s.container || s.container === e ? a.width() + a.scrollLeft() : t(s.container).offset().left + t(s.container).width()) <= t(i).offset().left - s.threshold
        }, t.abovethetop = function (i, s) {
            return (void 0 === s.container || s.container === e ? a.scrollTop() : t(s.container).offset().top) >= t(i).offset().top + s.threshold + t(i).height()
        }, t.leftofbegin = function (i, s) {
            return (void 0 === s.container || s.container === e ? a.scrollLeft() : t(s.container).offset().left) >= t(i).offset().left + s.threshold + t(i).width()
        ...
        t.fn.pin = function (e) {
            ...
            var n = function () {
                    for (var i = 0, n = s.length; i < n; i++) {
                        var r = s[i];
                        if (e.minWidth && o.width() <= e.minWidth) r.parent().is(".pin-wrapper") && r.unwrap(), r.css({
                            width: "",
                            left: "",
                            top: "",
                            position: ""
                        }), e.activeClass && r.removeClass(e.activeClass), a = !0;
                        else {
                            a = !1;
                ...
                r = function () {
                    if (!a) {
                        i = o.scrollTop();
                        for (var n = [], r = 0, l = s.length; r < l; r++) {
                            var h = t(s[r]),
                                d = h.data("pin");
                            if (d) {
                                n.push(h);
                                var c = d.from - d.pad.bottom,
                                    p = d.to - d.pad.top;
                                c + h.outerHeight() > d.end ? h.css("position", "") : c < i && p > i ? (!("fixed" == h.css("position")) && h.css({
                                    left: h.offset().left,
                                    top: d.pad.top
            ...
            return this.each(function () {
                var e = t(this),
                    i = t(this).data("pin") || {};
                i && i.update || (s.push(e), t("img", this).one("load", n), i.update = l, t(this).data("pin", i))
            }), o.scroll(r), o.resize(function () {
                n()
            }), n(), o.load(l), this
        }
    }(jQuery),
    function (t) {
        "use strict";
        t("body").on("click", ".nav-tabs .close", function () {
            var e = t(this).closest('a[data-toggle="tab"]').attr("href");
            e && (t(e).hasClass("active") && (t(this).closest("li").prev().addClass("active"), t(t(this).closest("li").prev().find("a").attr("href")).removeClass("fade").addClass("active")), t(e).remove() && t(this).closest("li").remove())
        })
    }(jQuery),
    function (t) {
        "use strict";
        t.numberGrow = function (e, i) {
            i = i || {};
            var s, a, o = t(e),
                n = 1e3 * (i.time || o.data("time")),
                r = i.num || o.data("value"),
                l = +new Date;
            a = setInterval(function () {
                s = +new Date;
                var t = s - l,
                    e = r * (t / n);
                t >= n ? (e = r, clearInterval(a)) : e = Math.floor(e), o.text(e)
            }, 16)
        }, t(window).on("load", function () {
            t('[data-ride="numberGrow"]').each(function () {
                t.numberGrow(this)
            })
        })
    }(jQuery),
    function (t) {
        ...
        })() || t("input.form-control").show(function () {
    ...
    function (t) {
        ...
        function i() {
            ...
            var i = o.scrollTop(),
                ...
                a = s + o.width(),
                n = i + o.height(),
                l = e(i + d.top, a + d.right, n + d.bottom, s + d.left);
            t.each(l, function (t, e) {
                "number" != typeof e.data("scrollSpy:ticks") && e.triggerHandler("scrollSpy:enter"), e.data("scrollSpy:ticks", h)
            }), t.each(r, function (t, e) {
                var i = e.data("scrollSpy:ticks");
                "number" == typeof i && i !== h && (e.triggerHandler("scrollSpy:exit"), e.data("scrollSpy:ticks", null))
            }), r = l
        }
        ...
        function a(t, e, i) {
            ...
            i || (i = {});
            var l = function () {
                r = !1 === i.leading ? 0 : c(), n = null, o = t.apply(s, a), s = a = null
            };
            return function () {
                var h = c();
                r || !1 !== i.leading || (r = h);
                var d = e - (h - r);
                return s = this, a = arguments, d <= 0 ? (clearTimeout(n), n = null, r = h, o = t.apply(s, a), s = a = null) : n || !1 === i.trailing || (n = setTimeout(l, d)), o
            }
        }
        var o = t(window),
            n = [],
        ...
        t.scrollSpy = function (e, s) {
            e = t(e), e.each(function (e, i) {
                n.push(t(i))
            }), s = s || {
                throttle: 100
            }, d.top = s.offsetTop || 0, d.right = s.offsetRight || 0, d.bottom = s.offsetBottom || 0, d.left = s.offsetLeft || 0;
            var r = a(i, s.throttle || 100),
                h = function () {
                    t(document).ready(r)
                };
            return l || (o.on("scroll", h), o.on("resize", h), l = !0), setTimeout(h, 0), e
        }, t.winSizeSpy = function (e) {
            return t.winSizeSpy = function () {
                return o
            }, e = e || {
                throttle: 100
            }, o.on("resize", a(s, e.throttle || 100))
    ...
    function (t) {
        ...
        e.prototype.listen = function () {
            ...
            var e = this._fullWidth,
                s = this._fullHeight,
                a = (t(window).scrollTop(), e / this._targetImage.width),
                o = t(window).height() - i.OFFSET,
                n = t(window).width() - i.OFFSET,
                r = e / s,
                l = n / o;
            this._imgScaleFactor = e < n && s < o ? a : r < l ? o / s * a : n / e * a
        }, i.prototype._triggerAnimation = function () {
            this._targetImage.offsetWidth;
            var e = t(this._targetImage).offset(),
                i = t(window).scrollTop(),
                s = i + t(window).height() / 2,
                a = t(window).width() / 2,
                o = e.top + this._targetImage.height / 2,
                n = e.left + this._targetImage.width / 2;
            this._translateY = s - o, this._translateX = a - n;
