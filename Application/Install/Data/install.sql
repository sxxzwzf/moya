...
INSERT INTO `ly_admin_config` (`id`, `title`, `name`, `value`, `group`, `type`, `options`, `tip`, `is_dev`, `is_system`, `create_time`, `update_time`, `sort`, `status`) VALUES
  ...
  (2, '网站标题', 'WEB_SITE_TITLE', '魔娅lyadmin', 1, 'text', '', '网站标题前台显示标题', 0, 1, 1378898976, 1379235274, 2, 1),
  ...
  (7, '网站关键字', 'WEB_SITE_KEYWORD', '魔娅,新一代云平台,微信小程序开发,微信应用号开发,魔娅网络,魔娅科技,魔娅CMF,魔娅OA,OpenCMF,CoreThink,山西魔娅网络科技,corethink官网,corethink手册,php框架,web框架,网站开发,php教程,php开发,开源php框架,魔娅科技,域名注册,魔娅短租,魔娅商城,魔娅Docker,魔娅金融,魔娅贷,魔娅搜,魔娅视频,魔娅教育,魔娅在线,魔娅钱包,魔娅支付,魔娅IM,魔娅CMF', 1, 'textarea', '', '网站搜索引擎关键字', 0, 1, 1378898976, 1381390100, 7, 1),
  (8, '版权信息', 'WEB_SITE_COPYRIGHT', 'Copyright © 山西魔娅网络科技有限公司 All rights reserved.', 1, 'text', '', '设置在网站底部显示的版权信息，如“版权所有 © 2014-2015 科斯克网络科技”', 0, 1, 1406991855, 1406992583, 8, 1),
  ...
  (11, '公司名称', 'COMPANY_TITLE', '山西魔娅网络科技有限公司', 3, 'text', '', '', 0, 1, 1481014715, 1481014715, 1, 1),
  (12, '公司地址', 'COMPANY_ADDRESS', '太原市小店区广东路38号', 3, 'text', '', '', 0, 1, 1481014768, 1481014768, 2, 1),
...
VALUES
  ...
  (15, 'main', 0, '产品展示', 'page', '<p>查看前台演示，请点击右上角“网站导航”查看具体内容。</p><p>查看后台演示，请点击顶部<a target=\"_blank\" href=\"http://demo.lingyun.net/admin2.php?s=/admin/login/login.html&amp;account=admin&amp;password=admin\" style=\"color: rgb(0, 115, 229); text-decoration: underline; outline: 0px; text-align: center;\">点击这里体验强大的魔娅后台管理</a>。</p>                            ', '', 'fa-search', 'lists', 'detail', 1486516611, 1488506030, 0, 1),
  (16, 'main', 0, '新闻动态', 'page', '<p>查看前台演示，请点击右上角“网站导航”查看具体内容。</p><p>查看后台演示，请点击顶部<a target=\"_blank\" href=\"http://demo.lingyun.net/admin2.php?s=/admin/login/login.html&amp;account=admin&amp;password=admin\" style=\"color: rgb(0, 115, 229); text-decoration: underline; outline: 0px; text-align: center;\">点击这里体验强大的魔娅后台管理</a>。</p>                            ', '', '', '', '', 1457084714, 1488505991, 0, 1),
  (17, 'main', 0, '联系我们', 'page', '<p>查看前台演示，请点击右上角“网站导航”查看具体内容。</p><p>查看后台演示，请点击顶部<a target=\"_blank\" href=\"http://demo.lingyun.net/admin2.php?s=/admin/login/login.html&amp;account=admin&amp;password=admin\" style=\"color: rgb(0, 115, 229); text-decoration: underline; outline: 0px; text-align: center;\">点击这里体验强大的魔娅后台管理</a>。</p>                            ', '', '', '', '', 1457084725, 1488506009, 0, 1),
  (18, 'main', 0, '案例展示', 'page', '<p>查看前台演示，请点击右上角“网站导航”查看具体内容。</p><p>查看后台演示，请点击顶部<a target=\"_blank\" href=\"http://demo.lingyun.net/admin2.php?s=/admin/login/login.html&amp;account=admin&amp;password=admin\" style=\"color: rgb(0, 115, 229); text-decoration: underline; outline: 0px; text-align: center;\">点击这里体验强大的魔娅后台管理</a>。</p><p>            </p>', '', '', '', '', 1457084583, 1488505982, 0, 1);
