...
class FlinkModel extends Model
{
    ...
    protected $_validate = array(
        array('title', 'require', '友链名称不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
    );
    ...
    {
        $result['logo_url'] = get_cover($result['cover']);
    }
     ...
     * @author jry <7661660@qq.com>
     */
    public function getList( $pid = 0, $limit = 10, $page = 1, $order = null, $map = null)
    {
        $con            = array();
        if ($pid) {
            $con["pid"] = array("eq", $pid);
        }
